# Rename_Extensions
A Bash script that converts all the files inside a specified windows-style path , into the desired file extension (assuming you know they are compatible e.g. dont try to convert a .mp3 file into .jpg or a video .vid file into png (and vice versa)
